...
def main():
    ...
    #generatereport = sdk.Job("Generate Report", "GenerateReporting ZAP Scan Report", GenerateReport,["Run Acitve Scan"])
    #stopzap = sdk.Job("Stop ZAP", "Stopping ZAP", StopZAP,["Generate Report"])
    sdk.serve([startzap, startproxy, runwalkthrough, runspiderscan, runactivescan])
